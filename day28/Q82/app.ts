...
function lenthOfString(str:string):Number{
    return str.length;
}
console.log(lenthOfString("Waqar"));// Outputs: 5
// We're simply asking how long the string "Waqar" is, and it tells us there are 5 characters
